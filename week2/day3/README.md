...
- Represented each car sample as a vector containing three numerical features.
- Combined multiple samples into a matrix with the shape `(samples, features)`.
...
- Generated additional random car samples and applied batch prediction to them.
